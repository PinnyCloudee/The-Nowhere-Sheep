...
/* ==================================================================== */
charadex.site = {
  title: "The Nowhere Sheep",
  url: "https://nowheresheep.com/",
  description: `Welcome to The Nowhere.`
}
...
charadex.sheet = {
  ...
  id: "1bj6F_klG0TSXB6DuPNPsawigGlxKweltzMPO3fkEtlM",
  ...
  options: {
    ...
    designTypes: ['All', 'Blank Whisp', 'Mystery Whisp', 'Rainbow Whisp', 'Event Whisp', 'Inspiration Whisp'],
    statuses: ['All', 'Wild', 'Unnamed', 'For Trade', 'Forever Homed', 'NPC'],
    rarity: ['All', 'Common', 'Uncommon', 'Rare', 'Very Rare', 'Legendary'],
    species: ['All', 'Sheep-oid'],
    itemTypes: ['All', 'Whisp', 'Material', 'Accessory', 'Magic'],
    traitTypes: ['All', 'Horns', 'Wings', 'Masks', 'Body'],
    accessoryTypes: ['All', 'OOAK', 'Outfit', 'Head', 'Body', 'Tail', 'Legs', 'Other' ],
    markingTypes: ['All', 'Mask', 'Fullbody', 'Body', 'Legs', 'Head', 'Tail'],
